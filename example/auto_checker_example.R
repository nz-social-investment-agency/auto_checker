...
folder_path <- "/nas/DataLab/MAA/MAAXXXX-YY/project/For submission"

column_types <- c(
  "cont_count" = 3,
  "conf_total_income" = 20,
  "business_entity" = 45
)

# linking column names as per lookup: first, second, entity
column_links = list(
  "conf_count" = c("count", NA, NA),
  "conf_total_income" = c("total_income", NA, "business_entity")
) 
